...
terraform {
  required_version = "<= 1.1.5" #Forcing which version of Terraform needs to be used
  required_providers {
    aws = {
...
resource "aws_key_pair" "deployer" {
  ...
  public_key = "ssh-rsa  root@ip-172-31-85-230.ec2.internal"
}
